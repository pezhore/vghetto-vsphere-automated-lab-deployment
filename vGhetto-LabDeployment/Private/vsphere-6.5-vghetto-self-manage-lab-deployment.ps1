...
$VIServer = $DeploymentConfig.VIServer
$VIUsername = $DeploymentConfig.VIUsername
$VIPassword = $DeploymentConfig.VIPassword
...
$NestedESXiApplianceOVA = $DeploymentConfig.NestedESXiAppliannceOVA
$VCSAInstallerPath = $DeploymentConfig.VCSAInstallerPath

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = $DeploymentConfig.NestedESXiHostnamesToIPs
